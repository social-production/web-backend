...
user_settings = table(
    ...
    sa.Column("public_feed_scope", sa.String(16), nullable=False, server_default="home"),
    ...
    sa.Column("personal_feed_scope", sa.String(16), nullable=False, server_default="following"),
