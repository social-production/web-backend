...
project_pull_requests = table(
    ...
    sa.Column("merge_url", sa.Text, nullable=True),
...
project_conversions = table(
    ...
    created_at(),
    sa.UniqueConstraint("predecessor_project_id", name="uq_project_conversions_predecessor"),
)

project_inherited_decisions = table(
    ...
    sa.Column("approval_threshold_percent", sa.Integer, nullable=False, server_default="66"),
    sa.Column("payload", JSONB, nullable=False, server_default=sa.text("'{}'::jsonb")),
    created_at(),
    sa.Index("ix_project_inherited_decisions_successor", "successor_project_id"),
)
